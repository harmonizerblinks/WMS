	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<img class="img-circle" src="images/logo/logo.png" width="204" height="136"><br/>Log in Inventory Management System
								...
								<?php 
									...
									if(isset($_POST['submit'])){
										...
										if ($verify->num_rows > 0) {
											...
											echo '<center style="color: red">Wrong username and password combination</center>'; 
											$conn->close();
